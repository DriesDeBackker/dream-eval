...
class ConnectionManager implements PacketForwarder {
	...
	final void sendEvent(UUID id, Event<? extends Serializable> event, String initialVar, Long sourceTime,
			Set<String> lockReleaseNodes) {
		final EventPacket pkt = new EventPacket(event, id, initialVar, sourceTime);
